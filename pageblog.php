                ...
                <div class="group w-full max-w-xs mx-auto border border-gray-300 rounded-3xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                    ...
                    <div class="p-6 bg-white">
                        ...
                        <div class="flex space-x-4">
                            <a href="editArticle.php?id=<?= $row['id']; ?>" class="text-blue-600 font-semibold hover:underline">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-5 inline-block mr-2">
                            ...
                            <a href="deleteArticle.php?id=<?= $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this article?');" class="text-red-600 font-semibold hover:underline">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-5 h-5 inline-block mr-2">
